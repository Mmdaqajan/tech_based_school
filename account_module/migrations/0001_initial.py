    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_joined', models.DateTimeField(default=datetime.datetime(2024, 8, 24, 12, 38, 22, 336292))),
                ('last_login', models.DateTimeField(blank=True, null=True)),
                ('phone', models.IntegerField()),
                ('password', models.IntegerField()),
                ('avatar', models.ImageField(blank=True, null=True, upload_to='uploads/images/profile')),
            ...
            managers=[
                ('objects', account_module.models.CustomUserManager()),
            ],
        ),
    ]
